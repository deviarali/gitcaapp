									...
									<tbody>
										<c:forEach items="${recentClients}" var="client">
											<tr>
												...
												<td><c:out value="${client.custCreatedDate}"></c:out></td>
												<td style="text-align: center;"><a href=""><i class="fa fa-edit" style="font-size: 28px; color: blue;"></i></a></td>
												<td style="text-align: center;"><a href="" class="confirmation"><i class="fa fa-trash" style="font-size: 28px; color: red"></i></a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
